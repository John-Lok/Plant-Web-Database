<footer id="footer">
    <div class="mainFlexbox">
        ...
        <div class="logo-text-container">
            ...
            <div style="width: 200;" class="text-below-image">
                <p class="text-below-logo">This website aims to preserve the indegenous knowledge of various plants for daily uses.</p>
            </div>
        </div>
    ...
    <div class="bottomFlexbox">
        ...
        <a href="#" style="text-decoration: none; color: white; margin-left: 20px;">Privacy Policy</a>
    </div>
